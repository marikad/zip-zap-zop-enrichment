...
$pag_defaults = array(
		'before'           => '<p>' . esc_attr__( 'READ MORE:', TEXT_DOMAIN ),
		'after'            => '</p>',
		'link_before'      => '',
		'link_after'       => '',
...
<div class="pm-single-blog-post-categories-container">
    ...
    <?php if($catsLen > 0) { ?>
    	...
    	<ul class="pm-single-blog-post-categories">
            ...
            <li class="icon"><i class="fa fa-folder"></i><?php //esc_attr_e('Posted in:',TEXT_DOMAIN); ?></li>
    ...
    <?php if($tagsLen > 0) { ?>
    	...
    	<ul class="pm-single-blog-post-tags">
            <li class="icon"><i class="fa fa-tags"></i><?php //esc_attr_e('Tagged in:',TEXT_DOMAIN); ?></li>
