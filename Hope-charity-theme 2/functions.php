...
function pm_hope_theme_setup() {
	...
	/***** DEFINE CONSTANTS ***************************************************************************************************/
	define('TEXT_DOMAIN', 'localization');
...
if( !function_exists('pm_ln_check_theme_updates') ) {
	...
	function pm_ln_check_theme_updates() {
		...
		$theme_loader = new ThemeUpdateChecker(
			'Hope-charity-theme',
			'http://www.microthemes.ca/theme-updates/commercial/hope-info.json',
			false
		);
...
if( !function_exists('pm_ln_custom_page_titles') ) {
	...
	function pm_ln_custom_page_titles( $title, $sep ) {
		...
		$title = '<title>';
			  ...
			  elseif (is_search()) {
				 $title .= ''. __('Search for', TEXT_DOMAIN) .' &quot;'.esc_html($s).'&quot; - '; }
			  elseif (!(is_404()) && (is_single()) || (is_page())) {
				 $title .= wp_title(''); echo ' - '; }
			  elseif (is_404()) {
				 $title .= ''. __('404 Error', TEXT_DOMAIN) .' - '; }
			  if (is_home()) {
	  ...
	  if ( $field_id == 'footerLayout') {
		$array = array(
		  array(
			...
			'label'   => esc_attr__( 'Footer 3 Wide Left Columns', TEXT_DOMAIN ),
			'src'     => OT_URL . '/assets/images/layout/footer-3-wide-left.png'
		  ),
		  array(
			'value'   => 'footer-three-wide-right',
			'label'   => esc_attr__( 'Footer 3 Wide Right Columns', TEXT_DOMAIN ),
...
if( !function_exists('pm_hope_posts_columns_id') ) {
	...
	function pm_hope_posts_columns_id($defaults){
		$defaults['wps_post_id'] = esc_attr__('ID', TEXT_DOMAIN);
		return $defaults;
	}
...
if( !function_exists('pm_hope_custom_nextpage_links') ) {
	...
	function pm_hope_custom_nextpage_links($defaults) {
		$args = array(
			'before' => '<div class="pm_paginated-posts"><p>'. esc_attr__('Continue Reading: ', TEXT_DOMAIN) .'</p><ul class="pagination_multi clearfix">',
			'after' => '</ul></div>',
			'link_before'      => '<li>',
			'link_after'       => '</li>',
		);
		...
		if ( is_singular() && comments_open() && get_option( 'thread_comments' ) )
			...
			if(is_page_template('template-organizers.php') || is_page_template('template-events.php') || is_page_template('template-gallery.php')){
				...
				$array = array( 
					...
					'loading' => esc_attr__('Loading...', TEXT_DOMAIN)
				);
			...
			$wordpressOptionsArray = array( 
				...
				'optContactFormNameError' => esc_attr__('Please enter your name.', TEXT_DOMAIN),
				'optContactFormEmailError' => esc_attr__('Please enter a valid email address.', TEXT_DOMAIN),
				'optContactFormInquiryError' => esc_attr__('Please enter a message.', TEXT_DOMAIN),
				'optFormSuccessMessage' => esc_attr__('Thank you, your inquiry has been received.', TEXT_DOMAIN),
				'optFormErrorMessage' => esc_attr__('A system error occurred, please try again.', TEXT_DOMAIN),
	...
	function pm_hope_register_custom_sidebars() {
		...
		if (function_exists('register_sidebar')) {
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Homepage Single Column', TEXT_DOMAIN),
			...
			register_sidebar(array(
									'name' => esc_attr__('Homepage Left Column', TEXT_DOMAIN),
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Homepage Right Column', TEXT_DOMAIN),
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Blog Page Single Column', TEXT_DOMAIN),
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Blog Page Left Column', TEXT_DOMAIN),
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Blog Page Right Column', TEXT_DOMAIN),
			...
			register_sidebar(array(
									'name' => esc_attr__('Single Blog Post', TEXT_DOMAIN),
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Footer Column 1', TEXT_DOMAIN),
			...
			register_sidebar(array(
									'name' => esc_attr__('Footer Column 2', TEXT_DOMAIN),
			...
			register_sidebar(array(
									'name' => esc_attr__('Footer Column 3', TEXT_DOMAIN),
			...
			register_sidebar(array(
									'name' => esc_attr__('Footer Column 4', TEXT_DOMAIN),
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Woocommerce', TEXT_DOMAIN),
									'id' => 'woocomm_widget',
									'description'   => '',
									'class'         => '',
									'before_widget' => '<div id="%1$s" class="widget %2$s">',
			...
			register_sidebar(array(
									...
									'name' => esc_attr__('Page Sidebar', TEXT_DOMAIN),
									'id' => 'default_widget',
									'description'   => '',
									'class'         => '',
									'before_widget' => '<div id="%1$s" class="widget %2$s">',
...
if( !function_exists('pm_hope_kriesi_pagination') ) {
	...
	function pm_hope_kriesi_pagination($pages = '', $range = 2){
		 ...
		 $args = array(
			'before'           => '<li>' . esc_attr__('Pages:', TEXT_DOMAIN),
			'after'            => '</li>',
			'link_before'      => '',
			'link_after'       => '',
			'next_or_number'   => 'number',
			'nextpagelink'     => esc_attr__('Next page', TEXT_DOMAIN),
			'previouspagelink' => esc_attr__('Previous page', TEXT_DOMAIN),
			'pagelink'         => '%',
			'echo'             => 1
		);
