    ...
    protected function content($atts, $content = null) {
        ...
        <div class="pm-hover-item pm-event-activate">
            <div class="pm-hover-item-title-panel">
                ...
                <p><b><?php esc_attr_e('Organizer', TEXT_DOMAIN) ?>:</b> <?php esc_attr_e($postAuthor); ?></p>
            </div>
            <div class="pm-hover-item-details">
                <div class="pm-hover-item-spacer">
                    <ul class="pm-event-info-ul-date">
                        ...
                        <li class="visible-phone" style="margin-top:15px;"><a href="<?php echo esc_url($postLink); ?>"><?php esc_attr_e('View Event',TEXT_DOMAIN); ?> &raquo;</a></li>
                    </ul>
                    <div class="pm-event-info-excerpt" style="float:none !important; width:auto !important;">
                        ...
                        <p><a href="<?php echo esc_url($postLink); ?>"><?php esc_attr_e('View Event',TEXT_DOMAIN); ?> &raquo;</a></p>
                    </div>
                </div>
            </div>
...
vc_map( array(
    ...
    "name"      => __("Single Event Post", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Event Post ID", TEXT_DOMAIN),
            "param_name" => "id",
            "description" => __("Enter the post ID number of the event post you wish to display.", TEXT_DOMAIN),
