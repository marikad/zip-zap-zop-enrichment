...
class WPBakeryShortCode_pm_ln_event_posts extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        <div class="row">
				...
				<div class="span6 pm-event-post-shortcode-overflow">
					...
					<div class="pm-hover-item pm-event-activate">
						<div class="pm-hover-item-title-panel">
							...
							<p><b><?php esc_attr_e('Organizer', TEXT_DOMAIN); ?>:</b> <?php the_author(); ?></p>
						</div>
						<div class="pm-hover-item-details">
							<div class="pm-hover-item-spacer">							
								<ul class="pm-event-info-ul-date">
									...
									<li class="visible-phone" style="margin-top:15px;"><a href="<?php the_permalink(); ?>"><?php esc_attr_e('View Event',TEXT_DOMAIN); ?> &raquo;</a></li>
								</ul>							
								<div class="pm-event-info-excerpt">
									...
									<p><a href="<?php the_permalink(); ?>"><?php esc_attr_e('View Event',TEXT_DOMAIN); ?> &raquo;</a></p>
								</div>								
							</div>
						</div>
			...
			<?php endwhile; else: ?>
				<div class="span12">
				 <p><?php esc_attr_e('No event posts were found.', TEXT_DOMAIN); ?></p>
				</div>
			<?php endif; ?>
...
vc_map( array(
    ...
    "name"      => __("Event Posts", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "description" => __("Select the number of events you wish to display. Use -1 to display all events.", TEXT_DOMAIN),
		...
		array(
            ...
            "param_name" => "order",
            "description" => __("Set the order in which the posts are displayed. ASC = ascending / DESC = descending", TEXT_DOMAIN),
		...
		array(
            ...
            "param_name" => "category",
            "description" => __("If you wish to display event posts based on a specific event category then enter the event category slug here.", TEXT_DOMAIN),
			"value" => ''
        ),
