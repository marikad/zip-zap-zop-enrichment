...
vc_map( array(
    ...
    "name"      => __("Feature Box", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "param_name" => "title",
            //"description" => __("Accepts a FontAwesome 4 icon value. (Ex. fa fa-thumbs-o-up)", TEXT_DOMAIN),
			"value" => ''
        ),
		...
		array(
            "type" => "attach_image",
            "heading" => __("Icon Image", TEXT_DOMAIN),
            "param_name" => "icon_image",
            "description" => __("Upload a custom icon image if required.", TEXT_DOMAIN)
        ),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Button Text Color", TEXT_DOMAIN),
