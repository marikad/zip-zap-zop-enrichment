...
class WPBakeryShortCode_pm_ln_post_items extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        <?php if ($post_query->have_posts()) : while ($post_query->have_posts()) : $post_query->the_post(); ?>
            ...
            <div class="span4 pm-post-item-shortcode">
                ...
                <div class="pm-hover-item">
                    ...
                    <p><b><?php  esc_attr_e('Posted', TEXT_DOMAIN); ?></b> <?php esc_attr_e($postDate); ?><b> <?php esc_attr_e('by', TEXT_DOMAIN); ?></b> <?php the_author(); ?></p> 
                    ...
                    <div class="pm-hover-item-details">
                        <div class="pm-hover-item-spacer">
                            ...
                            <a href="<?php the_permalink(); ?>"><?php esc_attr_e('Read More', TEXT_DOMAIN); ?> &raquo;</a>
		...
		<?php endwhile; else: ?>
			<div class="span12">
			 <p><?php esc_attr__('No posts were found.', TEXT_DOMAIN); ?></p>
			</div>
		<?php endif; ?>
...
vc_map( array(
    ...
    "params"    => array(
		...
		array(
            ...
            "description" => __("Select the number of news posts you wish to display. Use -1 to display all news posts.", TEXT_DOMAIN),
