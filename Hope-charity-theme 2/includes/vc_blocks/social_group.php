...
vc_map( array(
    "name" => __("Icon Group", TEXT_DOMAIN),
...
vc_map( array(
    "name" => __("Icon Group Item", TEXT_DOMAIN),
    ...
    "params" => array(
		...
		array(
            "type" => "dropdown",
            "heading" => __("Window Target", TEXT_DOMAIN),
            "param_name" => "target",
            "description" => __("Set the browser target window for the link.", TEXT_DOMAIN),
			"value"      => array( '_self' => '_self', '_blank' => '_blank' ), //Add default value in $atts
        ),

		array(
            "type" => "textfield",
            "heading" => __("Size", TEXT_DOMAIN),
            "param_name" => "size",
