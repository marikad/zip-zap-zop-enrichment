...
class WPBakeryShortCode_pm_ln_staff_posts extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
                ...
                <div class="pm-hover-item pm-organizer-activate">
                    ...
                    <div class="pm-hover-item-details">
                        <div class="pm-hover-item-spacer">
                            ...
                            <p><a href="<?php the_permalink(); ?>"><?php esc_attr_e('View full profile',TEXT_DOMAIN); ?> &raquo;</a></p>
        ...
        <?php endwhile; else: ?>
            <div class="span12">
             <p><?php esc_attr_e('No staff posts were found.', TEXT_DOMAIN); ?></p>
            </div>
        <?php endif; ?>
...
vc_map( array(
    ...
    "name"      => __("Organizer Posts", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "description" => __("Select the number of organizer profiles you wish to display. Use -1 to display all organizer profiles.", TEXT_DOMAIN),
		...
		array(
            "type" => "textfield",
            "heading" => __("Organizer Title", TEXT_DOMAIN),
            "param_name" => "organiser_title",
            "description" => __("If you wish to display organizer profiles based on a specific title then enter the organizer slug here.", TEXT_DOMAIN),
			"value" => ''
        ),
