        ...
        <div class="pm-hover-item pm-organizer-activate">
            ...
            <div class="pm-hover-item-details">
                <div class="pm-hover-item-spacer">
                    ...
                    <p><a href="<?php echo esc_url($postLink); ?>"><?php  esc_attr_e('View full profile', TEXT_DOMAIN); ?> &raquo;</a></p>
...
vc_map( array(
    ...
    "name"      => __("Organizer Profile", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            ...
            "param_name" => "post_id",
            "description" => __("Enter the ID number of the organizer post you wish to display.", TEXT_DOMAIN),
			"value" => ''
        ),
		...
		array(
            ...
            "param_name" => "icon",
            "description" => __("Accepts a FontAwesome 4 value icon. (Ex. fa fa-user)", TEXT_DOMAIN),
			"value" => 'fa fa-user'
        ),
