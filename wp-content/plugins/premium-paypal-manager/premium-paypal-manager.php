...
$pm_premium_paypal_manager_version = '1.4.2';
...
if ( !class_exists( 'PremiumPaypalManager' ) ) {
	...
	class PremiumPaypalManager {
		...
		public function pm_paypal_settings_page() {
			...
			global $pm_premium_paypal_manager_version;
			...
			<div class="wrap">
				<?php screen_icon(); ?>
				<h2><?php _e('Premium Paypal Manager v', 'pmLocalization') ?> <?php echo $pm_premium_paypal_manager_version; ?> Settings</h2>
                ...
                <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
                    ...
                    <select id="pm_payment_currency" name="pm_payment_currency" class="pm-paypal-textfield ">
                      ...
                      <option value="<?php _e('EUR', 'pmLocalization') ?>" <?php selected( $payment_currency, 'EUR' ); ?>><?php _e('Euro Dollar', 'pmLocalization') ?></option>
              		  <option value="<?php _e('GBP', 'pmLocalization') ?>" <?php selected( $payment_currency, 'GBP' ); ?>><?php _e('Pound Sterling', 'pmLocalization') ?></option>
                    ...
                    <select id="pm_payment_currency_symbol" name="pm_payment_currency_symbol" class="pm-paypal-textfield ">
                      <option value="<?php _e('dollar', 'pmLocalization') ?>" <?php selected( $pm_payment_currency_symbol, 'dollar' ); ?>><?php _e('Dollar - $', 'pmLocalization') ?></option>
                      <option value="<?php _e('euro', 'pmLocalization') ?>" <?php selected( $pm_payment_currency_symbol, 'euro' ); ?>><?php _e('Euro - &euro;', 'pmLocalization') ?></option>
              		  <option value="<?php _e('pound', 'pmLocalization') ?>" <?php selected( $pm_payment_currency_symbol, 'pound' ); ?>><?php _e('Pound Sterling - &pound;', 'pmLocalization') ?></option>
                      <option value="<?php _e('japanese', 'pmLocalization') ?>" <?php selected( $pm_payment_currency_symbol, 'japanese' ); ?>><?php _e('Japanese Yen - &yen;', 'pmLocalization') ?></option>
                    </select>
