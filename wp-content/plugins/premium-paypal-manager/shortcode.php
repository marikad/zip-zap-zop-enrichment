...
function add_pm_paypal_manager_plugin( $atts ) {
	...
	$currencySymbol = '';
	if( $pm_payment_currency_symbol == 'dollar' ) {
		$currencySymbol = '$';
	} else if($pm_payment_currency_symbol == 'euro') {
		$currencySymbol = '&euro;';
	} else if($pm_payment_currency_symbol == 'pound') {
		$currencySymbol = '&pound;';
	} else if($pm_payment_currency_symbol == 'japanese') {
		$currencySymbol = '&yen;';
	} else {
		//do nothing	
	}
