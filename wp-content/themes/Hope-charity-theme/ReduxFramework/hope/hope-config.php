    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
			...
			$this->sections[] = array(
			  ...
			  'fields'    => array(
				...
				array(
                        ...
                        'type'      => 'text',
                        'title'     => __('Custom Slider', 'localization'),
                        'subtitle'  => __('You can display a custom slider on the default index page by providing a slider shortcode here. <strong>NOTE:</strong> Be sure to disable the Feature Slider under Appearance -> Customize -> Feature Slider Options', 'localization'),
                        //'desc'      => __('NOTE: if you would like your slider to sit underneath the navigation bar than wrap your shortcode within the "sliderContainer" shortcode.', 'localization'),
                        //'validate'  => 'html',
						'default' => ''
                ),
			...
			$this->sections[] = array(
			  ...
			  'icon'      => 'el-icon-cogs',
			  'title'     => __('Feature Slider', 'localization'),
			  'heading'   => __('Feature Slider', 'localization'),
