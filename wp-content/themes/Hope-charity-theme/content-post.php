...
<div class="pm-hover-item">
    <div class="pm-hover-item-title-panel">
        ...
        <?php if($displayMetaInfo === 'on') : ?>
        	<p><b><?php esc_attr_e('Posted', TEXT_DOMAIN) ?></b> <?php the_time('l F d, Y'); ?> <b><?php esc_attr_e('by', TEXT_DOMAIN) ?></b> <?php the_author(); ?></p>
        <?php endif; ?>
            ...
            <div class="pm_post_tags">
                <?php if( !is_search() ) : ?>
                    ...
                    <?php if($displaySocialMeta === 'on') : ?>
                    	...
                    	<?php echo get_comments_number(); ?> <?php esc_attr_e('comments', TEXT_DOMAIN) ?>
