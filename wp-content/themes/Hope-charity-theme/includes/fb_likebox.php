...
class fb_likebox_widget extends WP_Widget {
	function fb_likebox_widget() {
		...
		$widget_ops = array('classname' => 'Like-box','description' => esc_attr__('Facebook Like Box',TEXT_DOMAIN));

		parent::__construct('Like-box',esc_attr__('[Micro Themes] - Facebook Likebox',TEXT_DOMAIN),$widget_ops);
...
function form( $instance ) {
		...
		<p>  
            ...
            <label for="<?php echo $this->get_field_id( 'show_header' ); ?>"><?php esc_attr_e('Show Header?', TEXT_DOMAIN); ?></label>  
        </p>  
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'show_faces' ); ?>"><?php esc_attr_e('Show Faces?', TEXT_DOMAIN); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'show_border' ); ?>"><?php esc_attr_e('Show Border?', TEXT_DOMAIN); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'show_stream' ); ?>"><?php esc_attr_e('Show Stream?', TEXT_DOMAIN); ?></label>  
        </p>  
    	...
    	<p>
		<label for="<?php echo esc_html($this->get_field_id( 'page' )); ?>"><?php esc_attr_e('Facebook Page URL:', TEXT_DOMAIN) ?></label>
