...
class pulsar_flickr extends WP_Widget {
	function pulsar_flickr() {
		...
		$widget_ops = array('classname' => 'flickr','description' => esc_attr__('Flickr Widget - displays Flickr photos',TEXT_DOMAIN));
		parent::__construct('flickr-photo',esc_attr__('[Micro Themes] - Flickr',TEXT_DOMAIN),$widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_attr__( 'Flickr', TEXT_DOMAIN ) : $instance['title'], $instance, $this->id_base );
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'flickrID' )); ?>"><?php esc_attr_e('Flickr ID:', TEXT_DOMAIN) ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_attr_e('Number of Photos:', TEXT_DOMAIN) ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php esc_attr_e('Type (user or group):', TEXT_DOMAIN) ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php esc_attr_e('Display (random or latest):', TEXT_DOMAIN) ?></label>
