...
function staffItems($atts, $content = null) {
			...
			$html .= '<div class="pm-hover-item pm-organizer-activate">';
				...
				$html .= '<div class="pm-hover-item-details">';
					$html .= '<div class="pm-hover-item-spacer">';
						...
						$html .= '</p>';
						$html .= '<p><a href="'. get_the_permalink() .'">'. esc_attr__('View full profile',TEXT_DOMAIN) .' &raquo;</a></p>';						
					$html .= '</div>';
				$html .= '</div>';
	...
	endwhile; else:
		$html .= '<div class="span12">';
		 $html .= '<p>'. esc_attr__('No staff posts were found.', TEXT_DOMAIN) .'</p>';
		$html .= '</div>';
	endif;
...
function eventItems($atts, $content = null) {
	...
	//$html .= '<div class="container pm_paddingVertical60 pm_event_post">';
		$html .= '<div class="row">';
			...
			if ($post_query->have_posts()) : while ($post_query->have_posts()) : $post_query->the_post();
				...
				$html .= '<div class="span6 pm-event-post-shortcode-overflow">';
					...
					$html .= '<div class="pm-hover-item pm-event-activate">';
						$html .= '<div class="pm-hover-item-title-panel">';
							$html .= '<a class="fa fa-location-arrow pm_float_right" href="#"></a>';
							$html .= '<p><b>'. esc_attr__('Organizer', TEXT_DOMAIN) .':</b> '. get_the_author() .'</p>';
						$html .= '</div>';
						$html .= '<div class="pm-hover-item-details">';
							$html .= '<div class="pm-hover-item-spacer">';
								$html .= '<ul class="pm-event-info-ul-date">';
									...
									$html .= '<li class="visible-phone" style="margin-top:15px;"><a href="'. get_the_permalink() .'">'. esc_attr__('View Event',TEXT_DOMAIN) .' &raquo;</a></li>';
								$html .= '</ul>';
								$html .= '<div class="pm-event-info-excerpt">';
									...
									$html .= '</p>';
									$html .= '<p><a href="'. get_the_permalink() .'">'. esc_attr__('View Event',TEXT_DOMAIN) .' &raquo;</a></p>';
								$html .= '</div>';
							$html .= '</div>';
						$html .= '</div>';
						$html .= '<div class="pm-hover-item-img">';					
			...
			endwhile; else:
				$html .= '<div class="span12">';
				 $html .= '<p>'.esc_attr__('No event posts were found.', TEXT_DOMAIN).'</p>';
				$html .= '</div>';
			endif;
...
function postItems($atts, $content = null) {
	...
	//Display Items
		...
		if ($post_query->have_posts()) : while ($post_query->have_posts()) : $post_query->the_post();
			...
			$html .= '<div class="span4 pm-post-item-shortcode">';
				...
				$html .= '<div class="pm-hover-item">';
					...
					$html .= '<p><b>'. esc_attr__('Posted', TEXT_DOMAIN) .'</b> '.$postDate.'<b> '. esc_attr__('by', TEXT_DOMAIN) .'</b> '.get_the_author().'</p>';
					...
					$html .= '<div class="pm-hover-item-details">';
						$html .= '<div class="pm-hover-item-spacer">';
							...
							$html .= '<a href="'.get_the_permalink().'">'. esc_attr__('Read More', TEXT_DOMAIN) .' &raquo;</a>';
							
							if( $displayCommentsCount === 'on' ) {
							
								$html .= '<div class="pm_post_tags">';
								$html .= '<i class="fa fa-comment"></i> '.get_comments_number().' '. esc_attr__('comments', TEXT_DOMAIN) .'';	
								$html .= '</div>';
		...
		endwhile; else:
			$html .= '<div class="span12">';
			 $html .= '<p>'.esc_attr__('No posts were found.', TEXT_DOMAIN).'</p>';
			$html .= '</div>';
		endif;
		...
		$html .= '<div class="pm-hover-item-details">';
			$html .= '<div class="pm-hover-item-spacer">';
				$html .= '<p>';
				 $html .= $shortExcerpt .'...';
				$html .= '</p>';
				$html .= '<p><a href="'.$postLink.'">'. esc_attr__('View full profile',TEXT_DOMAIN).' &raquo;</a></p>';
...
function eventPost($atts) {
	...
	$html .= '<div class="pm-hover-item pm-event-activate">';
		$html .= '<div class="pm-hover-item-title-panel">';
			$html .= '<a class="fa fa-location-arrow pm_float_right" href="#"></a>';
			$html .= '<p><b>'. esc_attr__('Organizer', TEXT_DOMAIN) .':</b> '.$postAuthor.'</p>';
		$html .= '</div>';
		$html .= '<div class="pm-hover-item-details">';
			$html .= '<div class="pm-hover-item-spacer">';
				$html .= '<ul class="pm-event-info-ul-date">';
					...
					$html .= '<li class="visible-phone" style="margin-top:15px;"><a href="'.$postLink.'">'.esc_attr__('View Event',TEXT_DOMAIN).' &raquo;</a></li>';
				$html .= '</ul>';
				$html .= '<div class="pm-event-info-excerpt" style="float:none !important; width:auto !important;">';
					...
					$html .= '<p><a href="'.$postLink.'">'.esc_attr__('View Event',TEXT_DOMAIN).' &raquo;</a></p>';
				$html .= '</div>';
			$html .= '</div>';
		$html .= '</div>';
		$html .= '<div class="pm-hover-item-img">';
	...
	$html .= '<div class="pm-single-post-shortcode-container">';
		...
		$html .= '<div class="pm-hover-item">';
			...
			if( $displayMetaInfo === 'on' ) {
				$html .= '<p><b>'. esc_attr__('Posted',TEXT_DOMAIN) .'</b> '.$postDate.'<b> '. esc_attr__('by',TEXT_DOMAIN) .'</b> '.$postAuthor.'</p>';
			}
			...
			$html .= '<div class="pm-hover-item-details">';
				$html .= '<div class="pm-hover-item-spacer">';
					...
					$html .= '<a href="'.$postLink.'">'. esc_attr__('Read More',TEXT_DOMAIN) .' &raquo;</a>';
