        ...
        <div class="pm-single-post-shortcode-container">
            ...
            <div class="pm-hover-item">
                ...
                <?php if( $display_meta === 'on' ) { ?>
                    <p><b><?php esc_attr_e('Posted',TEXT_DOMAIN); ?></b> <?php esc_attr_e($postDate); ?><b> <?php esc_attr_e('by',TEXT_DOMAIN); ?></b> <?php esc_attr_e($postAuthor); ?></p>
                <?php } ?>
                ...
                <div class="pm-hover-item-details">
                    <div class="pm-hover-item-spacer">
                        ...
                        <a href="<?php echo esc_url($postLink); ?>"><?php esc_attr_e('Read More',TEXT_DOMAIN); ?> &raquo;</a>
                    
                        
                        <?php if($display_comments_count === 'on'){ ?>
                            <div class="pm_post_tags">
                            <i class="fa fa-comment"></i><?php echo get_comments_number(); ?> <?php esc_attr_e('comments', TEXT_DOMAIN); ?>	
                            </div>
                        <?php } else { ?>
...
vc_map( array(
    ...
    "name"      => __("Single Post", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Post ID", TEXT_DOMAIN),
            "param_name" => "id",
            "description" => __("Enter the post ID number of the post you wish to display.", TEXT_DOMAIN),
			"value" => ''
        ),
		
		array(
            "type" => "dropdown",
            "heading" => __("Display Social Links?", TEXT_DOMAIN),
		...
		array(
            "type" => "dropdown",
            "heading" => __("Display Comments Count?", TEXT_DOMAIN),
		...
		array(
            "type" => "dropdown",
            "heading" => __("Display Meta info?", TEXT_DOMAIN),
