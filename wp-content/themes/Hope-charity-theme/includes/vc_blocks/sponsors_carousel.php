...
vc_map( array(
    ...
    "name"      => __("Sponsors Carousel", TEXT_DOMAIN),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Carousel Message", TEXT_DOMAIN),
            "param_name" => "sponsors_text",
            //"description" => __("Accepts a FontAwesome 4 value. (Ex. fa fa-thumbs-o-up)", TEXT_DOMAIN),
			"value"      => 'Our Sponsors'
        ),
		...
		array(
            "type" => "dropdown",
            "heading" => __("Controls", TEXT_DOMAIN),
            "param_name" => "controls",
            //"description" => __("Set the target window for the client link.", TEXT_DOMAIN),
			"value"      => array( 'true' => 'true', 'false' => 'false' ), //Add default value in $atts
        ),
		
		array(
            "type" => "dropdown",
            "heading" => __("Browser Target Window", TEXT_DOMAIN),
