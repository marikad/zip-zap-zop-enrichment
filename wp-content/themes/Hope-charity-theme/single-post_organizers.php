...
<div class="container pm_paddingVertical80">
    <div class="row">
              ...
              <div class="span4 pm_organizer_post_profile">
                ...
                <ul class="pm_organizer_single_details">
                    ...
                    <?php if($organizerNumber !== '') { ?>
                    	<li><?php esc_attr_e('Phone',TEXT_DOMAIN) ?>: <span><?php echo esc_attr($organizerNumber); ?></span></li>
                    <?php } ?>
                    
                    <?php if($organizerEmail !== '') { ?>
                    	<li><?php esc_attr_e('Email',TEXT_DOMAIN) ?>: <a href="mailto:<?php echo esc_attr($organizerEmail); ?>"><?php echo esc_attr($organizerEmail); ?></a></li>
                    <?php } ?>
                    
                    <?php if($organizerWebsite !== '') { ?>
                    	<li><?php esc_attr_e('Personal website',TEXT_DOMAIN) ?>: <a href="<?php echo esc_html($organizerWebsite); ?>" target="_blank"><?php echo esc_html($organizerWebsite); ?></a></li>
                    <?php } ?>
                    
                    <?php if($googlePlusProfile !== '' && $facebookProfile !== '' && $twitterProfile !== '' && $linkedinProfile !== '' && $skypeAddress !== '') { ?>
                    	<li><?php esc_attr_e('Social Connections',TEXT_DOMAIN) ?>:</li>
                    <?php } ?>
        ...
        <?php }
			...
			<?php esc_attr_e('Sorry, no content was found.', TEXT_DOMAIN); ?>
