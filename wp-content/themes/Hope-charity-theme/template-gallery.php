            ...
            <div class="pm-featured-header-container">
                ...
                <div class="pm-isotope-filter-container">
                    <ul class="pm-isotope-filter-system">
                        <li class="pm-isotope-filter-system-expand"><?php esc_attr_e('Currently Viewing:', TEXT_DOMAIN); ?> <i class="fa fa-angle-down"></i></li>
                        <li>
                        	<div class="pm-rounded-btn gallery-filter">
                            	<a href="#" class="current" id="all"><?php esc_attr_e('All', TEXT_DOMAIN); ?></a>
                            </div>
                        </li>
                        <?php
