        ...
        <div class="row">
            ...
            <div class="pm-dropdown pm-staff-menu">
                <div class="pm-dropmenu">
                    <p class="pm-menu-title"><?php esc_attr_e('View by Title', TEXT_DOMAIN); ?></p>
                ...
                <div class="pm-dropmenu-active">
                    <ul>
                        ...
                        <?php 
                            ...
                            echo '<li><a href="#" id="all">'.esc_attr__('View all', TEXT_DOMAIN).'</a></li>';
    ...
    <div class="row">
    	...
    	<div id="pm-isotope-organizers-container">
    		...
    		<?php if ($post_query->have_posts()) : while ($post_query->have_posts()) : $post_query->the_post(); ?>
                ...
                <?php endwhile; else: ?>
                 <p><?php esc_attr_e('No organizer profiles were found.', TEXT_DOMAIN); ?></p>
                <?php endif; ?>
