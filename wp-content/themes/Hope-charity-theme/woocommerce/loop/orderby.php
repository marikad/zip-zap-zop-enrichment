	...
	if( !isset($_GET['s']) ){
        ...
        <div class="pm-dropdown pm-shop-filter-menu">
            <div class="pm-dropmenu">
                <p class="pm-menu-title"><?php _e('Sort by', TEXT_DOMAIN); ?> <?php echo $currentOrderBy; ?> </p>
                <i class="fa fa-angle-down"></i>
            </div>
            <div class="pm-dropmenu-active">
                <ul>
                   <li><a href="?orderby=menu_order&product_orderby=price"><?php _e('Sort by', TEXT_DOMAIN); ?> <strong><?php _e('Default Order', TEXT_DOMAIN); ?></strong></a></li>
                   <li><a href="?orderby=popularity&product_orderby=price"><?php _e('Sort by', TEXT_DOMAIN); ?> <strong><?php _e('Popularity', TEXT_DOMAIN); ?></strong></a></li>
                   <li><a href="?orderby=rating&product_orderby=price"><?php _e('Sort by', TEXT_DOMAIN); ?> <strong><?php _e('Rating', TEXT_DOMAIN); ?></strong></a></li>
                   <li><a href="?orderby=date&product_orderby=price"><?php _e('Sort by', TEXT_DOMAIN); ?> <strong><?php _e('Latest', TEXT_DOMAIN); ?></strong></a></li>
                   <li><a href="?orderby=price&product_orderby=price"><?php _e('Sort by', TEXT_DOMAIN); ?> <strong><?php _e('Lowest Price', TEXT_DOMAIN); ?></strong></a></li>
                   <li><a href="?orderby=price-desc&product_orderby=price"><?php _e('Sort by', TEXT_DOMAIN); ?> <strong><?php _e('Highest Price', TEXT_DOMAIN); ?></strong></a></li>
                </ul>
            </div>
        </div> 
        <!-- /dropdown -->
